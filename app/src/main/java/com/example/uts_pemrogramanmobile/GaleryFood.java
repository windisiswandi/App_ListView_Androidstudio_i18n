...
//    public static final String FOOD_SELECTED = "foods_obj_key";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (kategori_food.toLowerCase().equals("padang food")) titleFoodContent.setText(getString(R.string.name_menu_food_padang));
        else if(kategori_food.toLowerCase().equals("lombok food")) titleFoodContent.setText(getString(R.string.name_menu_food_lombok));
        else if(kategori_food.toLowerCase().equals("palembang food")) titleFoodContent.setText(getString(R.string.name_menu_food_palembang));
        else if(kategori_food.toLowerCase().equals("aceh food")) titleFoodContent.setText(getString(R.string.name_menu_food_aceh));

        data_foods = DataFood.getDataFoodByJenis(kategori_food, this);
